  ...
  return (
    <header className="border-b border-line-strong bg-ink-950 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-5 flex items-center justify-between bg-ink-950 text-cream">
        ...
        {/* <!-- Right: add button (desktop) + hamburger (mobile) --> */}
        <div className="flex items-center gap-3">
          <button
            className="hidden md:flex bg-cream text-black hover:bg-gold font-mono text-[11px] tracking-tiny uppercase px-4 py-2 rounded-sm items-center gap-2 transition hover:-translate-y-px cursor-not-allowed"
            disabled
          >
            <HiPlus /> Add Friends
          </button>

          {/* Client-side hamburger lives in here */}
